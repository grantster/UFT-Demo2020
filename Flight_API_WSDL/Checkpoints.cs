...
namespace Script
{
    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity6_checkpoints(STActivityBase activity)
        {
            ...
            CpValObj valueExpectedObject2 = new CpValObj("100", XmlTypeCode.Int);
            ...
            BindDirection actualBindDirection3 = new BindDirection(_flow.StServiceCallActivity6, actualValueGetter3, actualValueSetter3);
